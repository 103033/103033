...
const token = 'NzU5MzcwODk4Nzc1NzM2MzIw.X28hQg.WJfkxSMii271hnl9KYNSLNn30Wo';
...
const welcomeChannelComment = "어서오세요 각종 문의는 **관리자**에게 디엠주세요 :yum:";
const byeChannelComment = "안녕히가세요 다음에 또 만나요 :scream:";
...
client.on("guildMemberAdd", (member) => {
  ...
  member.addRole(guild.roles.find(role => role.name == "미구매자"));
});
